...
## Stack
Python 3.9+ · Docker · systemd · RTL-SDR · Deepgram API / whisper.cpp
...
- [[mobile_adsb/CLAUDE|mobile_adsb]] — mobiele ADS-B
- [[airwave-aggregator/CLAUDE|airwave-aggregator]] — frequentie frontend
